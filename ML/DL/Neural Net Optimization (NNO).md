...
- Сжатие пересылаемых данные
	- Входная картинка
		- JPEG
	- Выходная картинка
		- PNG - для бинарных масок лучше чем JPEG?
- Декодирование картинки запекать в модель?
	- GPU vs CPU
- Пересылка данных между моделями
	- VRAM -> RAM -> VRAM
- Пре-процессинг на GPU
	- cuML
	- пример с поиском связных компонент
	- + батчинг
- Профайлер
