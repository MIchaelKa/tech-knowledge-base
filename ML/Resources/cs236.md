...
- Generation via reversing stochastic process
	...
	- You don't need to apply 1000 steps of denoising anymore
...
Forward and Reverse DE

Numerically integrating SDE that goes from noise to data
- SDE goes from noise to data.
	- What does it mean?
	- TODO
- Numerically integrating SDE =?  Solving


How to solve DE numerically?
